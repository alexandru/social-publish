...
/**
 * A coroutine dispatcher based on Java Virtual Threads (Project Loom) when available.
 *
 * On Java 21+: Creates a new virtual thread for each dispatched coroutine, providing lightweight
 * concurrency without the overhead of platform threads.
 *
 * On Java 17-20: Falls back to a cached thread pool executor.
 */
val Dispatchers.LOOM: CoroutineDispatcher
    get() =
        try {
            ...
            // Fallback to cached thread pool for Java < 21
