...
fun ImageUpload(
    ...
    Div(attrs = { classes("block") }) {
        Div(attrs = { classes("field") }) {
            Label(attrs = { classes("label") }) { Text("Image ($id)") }
            Div(attrs = { classes("file") }) {
                Label(attrs = { classes("file-label") }) {
                    ...
                    Span(attrs = { classes("file-cta") }) {
                        ...
                        Span(attrs = { classes("file-label") }) { Text("Choose an image file…") }
                    }
                }
            }
            Div {
                P(attrs = { classes("help") }) { Text("The image will be displayed in the post.") }
            }
            Div { Span { Text(state.file?.name ?: "") } }
        }

        Div(attrs = { classes("field") }) {
            Label(attrs = { classes("label") }) { Text("Alt text for image ($id)") }
