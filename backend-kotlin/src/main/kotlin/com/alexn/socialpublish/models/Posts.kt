...
@Serializable
data class NewMastodonPostResponse(override val module: String = "mastodon", val uri: String) :
  NewPostResponse()

@Serializable
data class NewRssPostResponse(override val module: String = "rss", val uri: String) :
  NewPostResponse()

@Serializable
data class NewTwitterPostResponse(override val module: String = "twitter", val id: String) :
  NewPostResponse()
