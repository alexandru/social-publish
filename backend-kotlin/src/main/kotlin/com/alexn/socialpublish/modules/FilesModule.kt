...
import com.alexn.socialpublish.db.Upload
...
class FilesModule(
    ...
    suspend fun uploadFile(call: ApplicationCall): ApiResult<FileUploadResponse> {
        return try {
            ...
            val processed = if (contentType?.startsWith("image/") == true) {
    ...
    private fun processImage(
        ...
        return try {
            ...
            val maxWidth = 1920
            val maxHeight = 1080
            val resized = if (width > maxWidth || height > maxHeight) {
